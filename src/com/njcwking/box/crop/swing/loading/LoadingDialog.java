package com.njcwking.box.crop.swing.loading;

import com.njcwking.box.crop.bus.RxBus;
import com.njcwking.box.crop.utils.GenerateTool;
 ...
 * 1. 当前进度 : 改变进度条
 * 2. 切图日志 : 打印日志
 * 3. 裁剪成功 : 切图成功，打印日志，按钮改成确认后关闭
 * 4. 裁剪失败 : 打出失败日志，按钮改成关闭
 */
public class LoadingDialog extends JDialog {

    public static final String MSG_CROP_CANCEL = "msg.image.crop.cancel";
